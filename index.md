...
address: "Room Doll 320, SIEPR Gunn Building, Stanford Institute for Economic Policy Research, 366 Galvez Street, Stanford, CA"      #  (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
enddate: 2019-07-11        # machine-readable end date for the workshop in YYYY-MM-DD format like 2019-07-11
instructor: ["Claudia Engel", "Lori Ling", "Linnea Shieh", "João Rodrigues", "Darach Miller (backup)" ] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Ashley Jester", "Zac Painter", "Darach Miller", "Irina Trapido", "Keith Bettinger", "Josh Quan"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
